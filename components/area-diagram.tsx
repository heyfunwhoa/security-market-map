...
function shortLines(label: string): string[] {
  const known: Record<string, string[]> = {
    ...
    "SaaS security posture": ["SaaS", "posture"],
    "Web application and API protection": ["WAAP"],
    Microsegmentation: ["Microseg"],
    "External attack surface": ["External", "surface"],
    "Cyber asset management": ["Asset", "inventory"],
    "OT and IoT security": ["OT", "IoT"],
    "Security ratings": ["Security", "ratings"],
    "Enterprise browser": ["Enterprise", "browser"],
    "AI application security": ["AI app", "security"],
    "Cyber recovery": ["Cyber", "recovery"],
    SecurityScorecard: ["Scorecard"],
    "Robust Intelligence": ["Robust", "Intel."],
    ...
    "Gem Security": ["Gem"],
    "Silk Security": ["Silk"],
    "Obsidian Security": ["Obsidian"],
    "Adaptive Shield": ["Adaptive", "Shield"],
    "Endor Labs": ["Endor", "Labs"],
    "Scribe Security": ["Scribe"],
    "Aikido Security": ["Aikido"],
    "OX Security": ["OX"],
    "Legit Security": ["Legit"],
    "Noname Security": ["Noname"],
    "Sweet Security": ["Sweet"],
    "Salt Security": ["Salt"],
    "Aqua Security": ["Aqua"],
    "Software supply chain": ["Supply", "chain"],
    "Cloud vulnerability management": ["Cloud", "vulns"],
    "Interactive application testing": ["IAST"],
    "Application security testing": ["App", "testing"],
    "Application runtime security": ["App", "runtime"],
    "Cloud-native application protection": ["CNAPP"],
    "Infrastructure-as-code security": ["IaC"],
    "Container and Kubernetes security": ["Containers"],
    "Cloud detection and response": ["Cloud", "detection"],
    "Static analysis (SAST)": ["SAST"],
    "Dynamic testing (DAST)": ["DAST"],
